...
/// <summary>
/// Represents an immutable query specification descriptor defining criteria, ordering, pagination, and projection from <typeparamref name="T"/> to <typeparamref name="TResult"/>.
/// </summary>
...
/// </remarks>
public sealed record QuerySpec<T, TResult>
{
    /// <summary>Gets an empty specification with no constraints.</summary>
    public static readonly QuerySpec<T, TResult> Empty = new();
    ...
    /// <summary>Gets the projection expression from <typeparamref name="T"/> to <typeparamref name="TResult"/>.</summary>
    public Expression<Func<T, TResult>>? Selector { get; init; }
    ...
    public QuerySpec<T, TResult> SeekAfter<TKey>(Expression<Func<T, TKey>> keySelector, TKey cursorValue, int take) =>
    ...
    /// <param name="take">The number of records to return.</param>
    /// <returns>A new specification with the cursor and limit applied.</returns>
    public QuerySpec<T, TResult> SeekBefore<TKey>(Expression<Func<T, TKey>> keySelector, TKey cursorValue, int take) =>
    ...
    public QuerySpec<T, TResult> WithCursor<TKey>(
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with an additional AND predicate.
    /// </summary>
    /// <param name="predicate">The predicate to add.</param>
    /// <returns>A new specification with the predicate appended to the criteria.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="predicate"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> Where(Expression<Func<T, bool>> predicate)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with a search filter across one or more string properties using logical OR.
    /// </summary>
    /// <param name="searchPhrase">The search term to look for.</param>
    ...
    public QuerySpec<T, TResult> Search(string searchPhrase, params Expression<Func<T, string?>>[] propertySelectors)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with the specified diagnostic query tag applied.
    /// </summary>
    ...
    public QuerySpec<T, TResult> TagWith(string tag)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with the specified projection.
    /// </summary>
    /// <param name="selector">The projection expression.</param>
    /// <returns>A new specification with the projection applied.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="selector"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> Select(Expression<Func<T, TResult>> selector)
    {
        ArgumentNullException.ThrowIfNull(selector);
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with an ascending order applied.
    /// </summary>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="keySelector"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> OrderBy<TKey>(Expression<Func<T, TKey>> keySelector)
    {
        ArgumentNullException.ThrowIfNull(keySelector);
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with a descending order applied.
    /// </summary>
    /// <typeparam name="TKey">The type of the ordering key.</typeparam>
    /// <param name="keySelector">The key selector.</param>
    /// <returns>A new specification with the ordering applied.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="keySelector"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> OrderByDescending<TKey>(Expression<Func<T, TKey>> keySelector)
    {
        ArgumentNullException.ThrowIfNull(keySelector);
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with a secondary ascending order applied.
    /// </summary>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="keySelector"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> ThenBy<TKey>(Expression<Func<T, TKey>> keySelector)
    {
        ArgumentNullException.ThrowIfNull(keySelector);
        return this with { OrderClauses = OrderClauses.Add(new OrderClause<T>(ConvertKeySelector(keySelector), OrderDirection.Ascending)) };
    }

    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with a secondary descending order applied.
    /// </summary>
    /// <typeparam name="TKey">The type of the sort key.</typeparam>
    /// <param name="keySelector">A function to extract a key from an element.</param>
    /// <returns>A new specification with the secondary descending ordering applied.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="keySelector"/> is <see langword="null"/></exception>
    public QuerySpec<T, TResult> ThenByDescending<TKey>(Expression<Func<T, TKey>> keySelector)
    {
        ArgumentNullException.ThrowIfNull(keySelector);
        return this with { OrderClauses = OrderClauses.Add(new OrderClause<T>(ConvertKeySelector(keySelector), OrderDirection.Descending)) };
    }

    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> with offset-based pagination applied.
    /// </summary>
    ...
    /// </exception>
    public QuerySpec<T, TResult> Page(int page, int pageSize)
    {
        ArgumentOutOfRangeException.ThrowIfLessThan(page, 1);
        ArgumentOutOfRangeException.ThrowIfLessThan(pageSize, 1);
        return this with { SkipCount = (page - 1) * pageSize, TakeCount = pageSize };
    }

    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> that skips the first <paramref name="count"/> records.
    /// </summary>
    ...
    public QuerySpec<T, TResult> Skip(int count)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> that returns at most <paramref name="count"/> records.
    /// </summary>
    ...
    public QuerySpec<T, TResult> Take(int count)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="QuerySpec{T, TResult}"/> that eliminates duplicate results.
    /// </summary>
    /// <returns>A new specification with distinct enabled.</returns>
    public QuerySpec<T, TResult> Distinct() => this with { IsDistinct = true };
