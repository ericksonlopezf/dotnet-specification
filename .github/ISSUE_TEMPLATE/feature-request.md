...
Please indicate the area your request relates to (check all that apply):
- [ ] New SQL dialect (which database?)
- [ ] New logical operator (e.g., `XOR`, aggregation)
- [ ] New `Spec.*` static factory / combinator
- [ ] New Roslyn analyzer rule (`SPEC0xx`)
- [ ] New Source Generator feature (`EricksonLopez.Specification.Generators`)
- [ ] New storage integration (which engine?)
