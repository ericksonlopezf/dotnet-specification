...
- [ ] `EricksonLopez.Specification.Result` *(tracked here; not currently included in `publish.yml` publish step)*
...
- [ ] My changes generate no new warnings (TreatWarningsAsErrors is enforced)
- [ ] I have added tests that prove my fix is effective or that my feature works
- [ ] New and existing unit tests pass locally with my changes
- [ ] I have run the benchmarks and there is no performance regression
